...
public class Delivery {
	...
	public String toString() {
		return "Delivery [matchId=" + matchId + ", inning=" + inning + ", battingTeam=" + battingTeam + ", bowlingTeam="
				+ bowlingTeam + ", over=" + over + ", ball=" + ball + ", batsman=" + batsman + ", nonStriker="
				+ nonStriker + ", bowler=" + bowler + ", isSuperOver=" + isSuperOver + ", wideRuns=" + wideRuns
				+ ", byeRuns=" + byeRuns + ", legbyeRuns=" + legbyeRuns + ", noballRuns=" + noballRuns
